...
const Rating = props => {
  ...
  switch (true) {
    case (r >= 4.75):
      stars = 'http://localhost:3000/yelp-assets/small_5.png';
      break;
    case (r >= 4.25):
      stars = 'http://localhost:3000/yelp-assets/small_4_half.png';
      break;
    case (r >= 3.75):
      stars = 'http://localhost:3000/yelp-assets/small_4.png';
      break;
    case (r >= 3.25):
      stars = 'http://localhost:3000/yelp-assets/small_3_half.png';
      break;
    case (r >= 2.75):
      stars = 'http://localhost:3000/yelp-assets/small_3.png';
      break;
    case (r >= 2.25):
      stars = 'http://localhost:3000/yelp-assets/small_2_half.png';
      break;
    case (r >= 1.75):
      stars = 'http://localhost:3000/yelp-assets/small_2.png';
      break;
    case (r >= 1.25):
      stars = 'http://localhost:3000/yelp-assets/small_1_half.png';
      break;
    case (r >= .75):
      stars = 'http://localhost:3000/yelp-assets/small_1.png';
      break;
    default:
      stars = 'http://localhost:3000/yelp-assets/small_0.png';
      break;
    }
  return (
